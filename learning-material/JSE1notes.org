...
*** Data Type
javascript data type are divided into two
- primitive (or simple): numbers, string, character
- complex (or composite): ex. arrays, object
